...
var form = document.querySelector(".modal-mailUs form");
var userName = document.querySelector(".modal-mailUs [name=user-name]");
var userEmail = document.querySelector(".modal-mailUs [name=user-email]");
var mailText = document.querySelector(".modal-mailUs [name=mail-text]");
